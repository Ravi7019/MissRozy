        ...
        if usr_cmd == "/start":
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("♥️BackUp Channel", url="https://t.me/KannadaFlix6")
                        ]
            else :
                await cmd.reply_photo(photo=lazy_pic,
    ...
    async def main(bot: Client, message: Message):
        ...
        if message.chat.type == enums.ChatType.PRIVATE:
            ...
            if message.from_user.id in Config.BANNED_USERS:
                await message.reply_text("KannadaFlix!\n\nContact [Support Group](https://t.me/KannadaFlix6)",
                                        disable_web_page_preview=True)
                return
        ...
        if "aboutbot" in cb_data:
            ...
            if Config.UPDATES_CHANNEL:
                ...
                try:
                    ...
                    await cmd.message.edit(
                        text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/KannadaFlix6).",
                        disable_web_page_preview=True
                    )
                    return
            if(Config.LAZY_MODE == True):
